...
import logging
import time
from typing import Any, Dict, Optional, TypeVar, Callable, Awaitable, Tuple
...
async def run_health_check(
    ...
    try:
        ...
        model = create_chat_model(config=config, timeout=timeout_sec, temperature=0, max_tokens=5)
        # 最小请求
