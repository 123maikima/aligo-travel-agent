...
def resolve_documents_dir() -> Path:
    """Resolve the knowledge document directory.

    Priority:
    1. RAG_DOCUMENTS_DIR environment variable
    2. Project-level data/documents directory
    3. Legacy skill data directory
    """
...
def main():
    ...
    try:
        # 创建模型
        print("1. 创建模型...")
        model = create_model_factory()("rag_knowledge")
        print("✓ 模型创建成功")
        print()
